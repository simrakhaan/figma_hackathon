      ...
      <div className="mt-12 border-t border-gray-200 pt-8">
        <div className="flex justify-between items-center w-[90%] mx-auto">
          ...
          <div className="flex space-x-4">
            ...
            <a href="http://www.linkedin.com/in/simra-khan-2641a72b5" className="w-8 h-8 rounded-full bg-[#151875] flex items-center justify-center text-white hover:bg-blue-700">
              <FaTwitter />
            </a>
            <a href="http://www.linkedin.com/in/simra-khan-2641a72b5" className="w-8 h-8 rounded-full bg-[#151875] flex items-center justify-center text-white hover:bg-blue-700">
              <FaInstagram />
